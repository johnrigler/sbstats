        ...
        [25] => Array
          [W-34] => Array
           [Sun] => Array
            [CDT] => Array
             [0306A00D2] => Array
              [4204000000-true-2-enable-PowerPC_POWER6] => Array
                   [uxdrtgwdv1] => Array
                     [aix] => Array
                        [vmstat] => Array
                            [00:00] => Array
   ...
   foreach($rest as $week => $rest)
    foreach($rest as $weekday => $rest)
     foreach($rest as $tz => $rest)
	  ...
	  { 
	  echo "<br>---------- $weekday $month $day $year $tz ($week) $serialno $hostname $os $type  ---------------\n";
	    ...
	    foreach($rest as $label => $datum)
                {
                $TopPoint = $BottomPoint - $datum;
	        echo "<br>     $label $datum $BottomPoint $TopPoint\n";
