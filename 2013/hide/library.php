...
function xDebugArrayRecursive( $Array , $Name="(unknown)" )
  {
  if(array_key_exists('debug',$_GET))
      {
...
function xCatArray( $Array , $Divider )
  {
  $FinalString = "";
...
function xMultiDayArray ( $Files , $Types , $Report ) {
...
function xReversePrettyDay ( $Day ) {
...
function xCalculateYesterday( $YMD , $Daysago = 1 )
{
$Year = substr($YMD,0,4);
...
function xCalculateLastWeek( $ISOWeek , $Weeksago = 1 )
{
