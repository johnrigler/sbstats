...
if ( substr($file,0,5) == "unixd" )
  {
        echo "<br><a href=graph.php?ymd=$ymd&granularity=05&stream=$file" . "_aixbase&report=aix1> $file</a>";
        echo "<a href=graph.php?week=$year-W$week&stream=$file" . "_aixbase&report=aix1> W </a>";
